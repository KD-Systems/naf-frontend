            ...
            <div className="">
              ...
              <div className="d-flex justify-content-between flex-column flex-md-row">
                ...
                <div className="flex-grow-1 pt-8">
                      ...
                      <tbody>
                        {invoice?.part_items?.map((item, index) => (
                          ...
                          >
                            ...
                            <td className="fs-5 text-dark fw-boldest pe-lg-6">{item?.unit_value}</td>
                            <td className="fs-5 text-dark fw-boldest pe-lg-6">{item?.total_value}</td>
                          </tr>
                        ))}
                  ...
                  <div className='fs-5 text-dark fw-boldest pe-lg-6 text-end'>TOTAL</div>
                </div>
              </div>
            </div>
          </div>
