          ...
          <h3 className="card-title align-items-start flex-column">
            ...
            <span className="text-muted fw-bold fs-7">
              ...
              <span className="fw-bold fs-5 text-dark">
                {part.unit === "piece"
                  ? parseFloat(totalStock).toFixed()
                  : part.unit_value}
              </span>{" "}
              {part.unit?.pluralize()} in stock
            </span>
          </h3>
                ...
                {!loading &&
                  stocks?.map((item, index) => (
                    <tr key={index}>
                      ...
                      <td>
                        {part.unit === "piece"
                          ? parseFloat(item.unit_value).toFixed()
                          : item.unit_value}
                      </td>

                      <td>{item.selling_price}</td>

                      <td>{item.unit_value * item.selling_price}</td>
                      ...
                      <td className="text-end">
                        <PermissionAbility permission="parts_stocks_show">
                          <Link
                            ...
                            to={"/panel/parts/" + id + "/stocks/" + item.id}
                          >
