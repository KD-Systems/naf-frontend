...
const Login = () => {
    return (
        ...
        <div class="d-flex flex-column flex-lg-row-auto w-xl-600px positon-xl-relative" style={{backgroundColor: "#F2C98A"}}>
            ...
            <div class="d-flex flex-column position-xl-fixed top-0 bottom-0 w-xl-600px scroll-y">
                ...
                <div class="d-flex flex-row-fluid flex-column text-center p-10 pt-lg-20">
                    ...
                    <h1 class="fw-bolder fs-2qx pb-5 pb-md-10" style={{backgroundColor: "#986923"}} >Welcome to Metronic</h1>
                  
                    
                    <p class="fw-bold fs-2" style={{backgroundColor: "#986923"}}>Discover Amazing Metronic
                ...
                style={{backgroundImage: "url(assets/media/illustrations/sketchy-1/13.png"}}></div>
