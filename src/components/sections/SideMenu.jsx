							...
							<div className="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500" id="#kt_aside_menu" data-kt-menu="true">
									...
									<div className="menu-sub menu-sub-accordion menu-active-bg">
										<div data-kt-menu-trigger="click" className="menu-item menu-accordion">
											...
											<div className="menu-sub menu-sub-accordion menu-active-bg">
												...
												<div className="menu-item">
													<a className="menu-link" href="../../demo1/dist/pages/profile/followers.html">
														<span className="menu-bullet">
															<span className="bullet bullet-dot"></span>
														</span>
										...
										<div data-kt-menu-trigger="click" className="menu-item menu-accordion">
											...
											<div className="menu-sub menu-sub-accordion menu-active-bg">
												<div className="menu-item">
													<a className="menu-link" href="../../demo1/dist/pages/wizards/horizontal.html">
														<span className="menu-bullet">
															<span className="bullet bullet-dot"></span>
														</span>
												...
												<div className="menu-item">
													<a className="menu-link" href="../../demo1/dist/pages/wizards/vertical.html">
														<span className="menu-bullet">
															<span className="bullet bullet-dot"></span>
														</span>
												...
												<div className="menu-item">
													<a className="menu-link" href="../../demo1/dist/pages/wizards/two-factor-authentication.html">
														<span className="menu-bullet">
															<span className="bullet bullet-dot"></span>
														</span>
												...
												<div className="menu-item">
													<a className="menu-link" href="../../demo1/dist/pages/wizards/create-app.html">
														<span className="menu-bullet">
															<span className="bullet bullet-dot"></span>
														</span>
												...
												<div className="menu-item">
													<a className="menu-link" href="../../demo1/dist/pages/wizards/create-campaign.html">
														<span className="menu-bullet">
															<span className="bullet bullet-dot"></span>
														</span>
												...
												<div className="menu-item">
													<a className="menu-link" href="../../demo1/dist/pages/wizards/create-account.html">
														<span className="menu-bullet">
															<span className="bullet bullet-dot"></span>
														</span>
												...
												<div className="menu-item">
													<a className="menu-link" href="../../demo1/dist/pages/wizards/create-project.html">
														<span className="menu-bullet">
															<span className="bullet bullet-dot"></span>
														</span>
												...
												<div className="menu-item">
													<a className="menu-link" href="../../demo1/dist/pages/wizards/offer-a-deal.html">
														<span className="menu-bullet">
															<span className="bullet bullet-dot"></span>
														</span>
										...
										<div data-kt-menu-trigger="click" className="menu-item menu-accordion">
											...
											<div className="menu-sub menu-sub-accordion menu-active-bg">
												<div className="menu-item">
													<a className="menu-link" href="../../demo1/dist/pages/search/horizontal.html">
														<span className="menu-bullet">
															<span className="bullet bullet-dot"></span>
														</span>
														<span className="menu-title">Horizontal</span>
												...
												<div className="menu-item">
													<a className="menu-link" href="../../demo1/dist/pages/search/vertical.html">
														<span className="menu-bullet">
															<span className="bullet bullet-dot"></span>
														</span>
														<span className="menu-title">Vertical</span>
												...
												<div className="menu-item">
													<a className="menu-link" href="../../demo1/dist/pages/search/users.html">
														<span className="menu-bullet">
															<span className="bullet bullet-dot"></span>
														</span>
												...
												<div className="menu-item">
													<a className="menu-link" href="../../demo1/dist/pages/search/select-location.html">
														<span className="menu-bullet">
															<span className="bullet bullet-dot"></span>
														</span>
								...
								<div data-kt-menu-trigger="click" className="menu-item menu-accordion">
									...
									<div className="menu-sub menu-sub-accordion">
										...
										<div className="menu-item">
											<a className="menu-link" href="!#" title="Coming soon" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right">
												<span className="menu-bullet">
													<span className="bullet bullet-dot"></span>
												</span>
														...
														<div className="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg py-lg-4 w-lg-225px">
															<div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start" className="menu-item menu-lg-down-accordion">
																...
																<div className="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg py-lg-4 w-lg-225px">
																	...
																	<div className="menu-item">
																		<a className="menu-link py-3" href="../../demo1/dist/pages/profile/followers.html">
																			<span className="menu-bullet">
																				<span className="bullet bullet-dot"></span>
																			</span>
																			<span className="menu-title">Followers</span>
															...
															<div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start" className="menu-item menu-lg-down-accordion">
																...
																<div className="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg py-lg-4 w-lg-225px">
																	...
																	<div className="menu-item">
																		<a className="menu-link py-3" href="../../demo1/dist/pages/wizards/two-factor-authentication.html">
																			<span className="menu-bullet">
																				<span className="bullet bullet-dot"></span>
																			</span>
																			<span className="menu-title">Two Factor Auth</span>
																	...
																	<div className="menu-item">
																		<a className="menu-link py-3" href="../../demo1/dist/pages/wizards/create-app.html">
																			<span className="menu-bullet">
																				<span className="bullet bullet-dot"></span>
																			</span>
																			<span className="menu-title">Create App</span>
																	...
																	<div className="menu-item">
																		<a className="menu-link py-3" href="../../demo1/dist/pages/wizards/create-campaign.html">
																			<span className="menu-bullet">
																				<span className="bullet bullet-dot"></span>
																			</span>
																			<span className="menu-title">Create Campaign</span>
																	...
																	<div className="menu-item">
																		<a className="menu-link py-3" href="../../demo1/dist/pages/wizards/create-account.html">
																			<span className="menu-bullet">
																				<span className="bullet bullet-dot"></span>
																			</span>
																			<span className="menu-title">Create Account</span>
																	...
																	<div className="menu-item">
																		<a className="menu-link py-3" href="../../demo1/dist/pages/wizards/create-project.html">
																			<span className="menu-bullet">
																				<span className="bullet bullet-dot"></span>
																			</span>
																			<span className="menu-title">Create Project</span>
																	...
																	<div className="menu-item">
																		<a className="menu-link py-3" href="../../demo1/dist/pages/wizards/offer-a-deal.html">
																			<span className="menu-bullet">
																				<span className="bullet bullet-dot"></span>
																			</span>
																			<span className="menu-title">Offer a Deal</span>
														...
														<div className="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg py-lg-4 w-lg-225px">
															...
															<div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start" className="menu-item menu-lg-down-accordion">
																...
																<div className="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg py-lg-4 w-lg-225px">
																	...
																	<div className="menu-item">
																		<a className="menu-link py-3" href="../../demo1/dist/modals/wizards/create-campaign.html">
																			<span className="menu-bullet">
																				<span className="bullet bullet-dot"></span>
																			</span>
																			<span className="menu-title">Create Campaign</span>
												...
												<div className="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-rounded-0 py-lg-4 w-lg-225px">
													...
													<div data-kt-menu-trigger="{default:'click', lg: 'hover'}" data-kt-menu-placement="right-start" className="menu-item menu-lg-down-accordion">
														...
														<div className="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg py-lg-4 w-lg-225px">
															...
															<div className="menu-item">
																<a className="menu-link py-3" href="!#" title="Coming soon" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-dismiss="click" data-bs-placement="right">
																	<span className="menu-bullet">
																		<span className="bullet bullet-dot"></span>
																	</span>
																	<span className="menu-title">Sales</span>
												...
												<div className="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-rounded-0 py-lg-4 w-lg-225px">
													...
													<div className="menu-item">
														<a className="menu-link py-3" href="../../demo1/dist/documentation/getting-started/changelog.html">
															...
															<span className="menu-title">Changelog v8.0.33</span>
														</a>
													</div>
												</div>
											</div>
							...
							<div id="kt_toolbar_container" className="container-fluid d-flex flex-stack">
								...
								<div className="d-flex align-items-center py-1">
									<div className="me-3">
										...
										<div className="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_61bc33c4ee0dc">
											...
											<div className="px-7 py-5">
												<div className="mb-10">
													...
													<div>
														<select className="form-select form-select-solid" data-kt-select2="true" data-placeholder="Select option" data-dropdown-parent="#kt_menu_61bc33c4ee0dc" data-allow-clear="true">
															<option></option>
												...
												<div className="mb-10">
													...
													<div className="d-flex">
														...
														<label className="form-check form-check-sm form-check-custom form-check-solid">
															<input className="form-check-input" type="checkbox" defaultValue="2" checked="checked" />
												...
												<div className="mb-10">
													...
													<div className="form-check form-switch form-switch-sm form-check-custom form-check-solid">
														<input className="form-check-input" type="checkbox" defaultValue="" name="notifications" checked="checked" />
										...
										<div className="card card-xl-stretch">
											<div className="card-header align-items-center border-0 mt-4">
												...
												<div className="card-toolbar">
													...
													<div className="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_61bc33c4f09dc">
														<div className="px-7 py-5">
															<div className="fs-5 text-dark fw-bolder">Filter Options</div>
														</div>
														<div className="separator border-gray-200"></div>
														<div className="px-7 py-5">
															<div className="mb-10">
																<label className="form-label fw-bold">Status:</label>
																<div>
																	<select className="form-select form-select-solid" data-kt-select2="true" data-placeholder="Select option" data-dropdown-parent="#kt_menu_61bc33c4f09dc" data-allow-clear="true">
																		<option></option>
																		<option defaultValue="1">Approved</option>
																		<option defaultValue="2">Pending</option>
																		<option defaultValue="2">In Process</option>
																...
																<td className="text-end">
																	<div className="d-flex flex-column w-100 me-2">
																		...
																		<div className="progress h-6px w-100">
																			<div className="progress-bar bg-primary" role="progressbar" style={{ width:"50%" }} aria-defaultValuenow="50" aria-defaultValuemin="0" aria-defaultValuemax="100"></div>
																		</div>
																	</div>
																</td>
																<td>
															...
															<tr>
																...
																<td className="text-end">
																	<div className="d-flex flex-column w-100 me-2">
																		...
																		<div className="progress h-6px w-100">
																			<div className="progress-bar bg-danger" role="progressbar" style={{ width:"70%" }} aria-defaultValuenow="70" aria-defaultValuemin="0" aria-defaultValuemax="100"></div>
																		</div>
																	</div>
																</td>
																<td>
															...
															<tr>
																...
																<td className="text-end">
																	<div className="d-flex flex-column w-100 me-2">
																		...
																		<div className="progress h-6px w-100">
																			<div className="progress-bar bg-success" role="progressbar" style={{ width:"60%" }} aria-defaultValuenow="60" aria-defaultValuemin="0" aria-defaultValuemax="100"></div>
																		</div>
																	</div>
																</td>
																<td>
															...
															<tr>
																...
																<td className="text-end">
																	<div className="d-flex flex-column w-100 me-2">
																		...
																		<div className="progress h-6px w-100">
																			<div className="progress-bar bg-warning" role="progressbar" style={{ width:"50%" }} aria-defaultValuenow="50" aria-defaultValuemin="0" aria-defaultValuemax="100"></div>
																		</div>
																	</div>
																</td>
																<td>
															...
															<tr>
																...
																<td className="text-end">
																	<div className="d-flex flex-column w-100 me-2">
																		...
																		<div className="progress h-6px w-100">
																			<div className="progress-bar bg-info" role="progressbar" style={{ width:"90%" }} aria-defaultValuenow="90" aria-defaultValuemin="0" aria-defaultValuemax="100"></div>
																		</div>
																	</div>
																</td>
																<td>
										...
										<div className="card card-xxl-stretch mb-5 mb-xl-8">
											<div className="card-header border-0 pt-5">
												...
												<div className="card-toolbar">
													<ul className="nav">
														<li className="nav-item">
															<a className="nav-link btn btn-sm btn-color-muted btn-active btn-active-secondary fw-bolder px-4 me-1" data-bs-toggle="tab" href="#kt_table_widget_5_tab_1">Month</a>
														</li>
														<li className="nav-item">
														...
														<li className="nav-item">
															<a className="nav-link btn btn-sm btn-color-muted btn-active btn-active-secondary fw-bolder px-4 active" data-bs-toggle="tab" href="#kt_table_widget_5_tab_3">Day</a>
														</li>
													</ul>
												</div>
											</div>
											<div className="card-body py-3">
												<div className="tab-content">
													<div className="tab-pane fade" id="kt_table_widget_5_tab_1">
														<div className="table-responsive">
													...
													<div className="tab-pane fade show active" id="kt_table_widget_5_tab_3">
														<div className="table-responsive">
															<table className="table table-row-dashed table-row-gray-200 align-middle gs-0 gy-4">
																<thead>
																	<tr className="border-0">
											...
											<form className="form" action="#" id="kt_modal_add_event_form">
												...
												<div className="modal-body py-10 px-lg-17">
													<div className="fv-row mb-9">
														<label className="fs-6 fw-bold required mb-2">Event Name</label>
													...
													<div className="fv-row mb-9">
														<label className="fs-6 fw-bold mb-2">Event Location</label>
												...
												<div className="d-flex">
													...
													<div className="mb-9">
														<div className="d-flex align-items-center mb-2">
															<span className="fs-3 fw-bolder me-3" data-kt-calendar="event_name"></span>
